...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES = 8
    V_LINES_SPACING = .4  # percentage of windo8w
    vertical_lines = []
    ...
    H_NB_LINES = 15
    H_LINES_SPACING = .1  # percentage of window
    horizontal_lines = []
    ...
    def reset_game(self):
        ...
        self.high_score_txt = "HIGH SCORE: " + str(self.high_score)
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_game_has_started:
            ...
            while self.current_offset_y >= spacing_y:
                ...
                self.score = int(float(self.current_y_loop))
                self.generate_tiles_coordinates()
                self.score_txt = "SCORE: " + str(self.current_y_loop)
                self.high_score = int(self.high_score)
               
                if self.score > self.high_score:
                    self.high_score = int(float(self.current_y_loop))
